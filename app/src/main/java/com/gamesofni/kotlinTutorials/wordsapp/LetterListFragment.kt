...
import com.gamesofni.kotlinTutorials.databinding.WordsappFragmentLetterListBinding

class LetterListFragment : Fragment() {
    private var _binding: WordsappFragmentLetterListBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = WordsappFragmentLetterListBinding.inflate(inflater, container, false)
