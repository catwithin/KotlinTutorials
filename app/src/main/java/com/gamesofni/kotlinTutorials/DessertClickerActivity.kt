...
import com.gamesofni.kotlinTutorials.databinding.ActivityDessertClickerBinding
...
class DessertClickerActivity : AppCompatActivity() {
         ...
         */
//        TODO: find out about 'outPersistentState' - smth new
        ...
        override fun onCreateOptionsMenu(menu: Menu): Boolean {
            menuInflater.inflate(R.menu.dessert_clicker_menu, menu)
