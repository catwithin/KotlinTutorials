...
import com.gamesofni.kotlinTutorials.busschedule.schedule.Schedule
import com.gamesofni.kotlinTutorials.databinding.BusscheduleBusStopItemBinding
...
class BusStopAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BusStopViewHolder {
        val viewHolder = BusStopViewHolder(
            BusscheduleBusStopItemBinding.inflate(
    ...
    class BusStopViewHolder(
        private var binding: BusscheduleBusStopItemBinding
